using AutoMapper;
using GameShopping.CartAPI.Config;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "GameShopping.CartAPI", Version = "v1" });
    c.EnableAnnotations();
...
{
    app.UseSwagger();
    app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "GameShopping.CartAPI v1"));
}
