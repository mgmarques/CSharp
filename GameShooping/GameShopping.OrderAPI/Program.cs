...
dbContextBuilder.UseSqlite(builder.Configuration.GetConnectionString("MySQlConnection"));
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "GaameShopping.OrderAPI", Version = "v1" });
    c.EnableAnnotations();
...
{
    app.UseSwagger();
    app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "GameShopping.OrderAPI v1"));
}
